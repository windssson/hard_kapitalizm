...
drop function if exists public.get_store_detail(uuid, uuid);
drop function if exists public.process_store_sales_on_entry(uuid, uuid);
drop function if exists public.get_store_list_items();
