  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            SecondaryTopBar(title: '${widget.selectedCity.name} - Tarla Türü'),
            Expanded(
                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: CachedAssetImage(fileName: type['icon'] ?? 'field.webp', fit: BoxFit.contain),
                      ),
                      if (isLocked)
                        Container(
                          width: 65.w,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            _buildDetailChip(Icons.layers, '${type['slot_capacity'] ?? 0} Slot', AppColors.blue),
                            SizedBox(width: 8.w),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _isProcessing
                  ...
                  : Text('TARLAYI İNŞA ET', style: TextStyle(color: _selectedType != null ? Colors.black : Colors.white30, fontSize: 14.sp, fontWeight: FontWeight.bold)),
            ),
          ),
        ],
      ),
  ...
  Future<void> _handleEstablish() async {
    ...
    try {
      ...
      if (result['success'] == true) {
        if (mounted) {
          AppSnackbar.show(context, title: 'Başarılı', message: 'Tarla inşaatı başladı!', type: SnackbarType.success);
          context.go('/fields');
        }
      } else {
