                  ...
                  Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: CachedAssetImage(fileName: type['icon'] ?? 'mine.webp', fit: BoxFit.contain),
                      ),
                      if (isLocked)
                        Container(
                          width: 65.w,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            _buildDetailChip(Icons.hardware, '${type['output_capacity'] ?? 0} Kap.', AppColors.blue),
                            SizedBox(width: 8.w),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _isProcessing
                  ...
                  : Text('MADENİ İNŞA ET', style: TextStyle(color: _selectedType != null ? Colors.black : Colors.white30, fontSize: 14.sp, fontWeight: FontWeight.bold)),
            ),
          ),
        ],
      ),
