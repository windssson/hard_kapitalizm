...
class _FactorySlotCard extends StatelessWidget {
  const _FactorySlotCard({
    required this.slot,
  ...
  Widget build(BuildContext context) {
    ...
    final title = slot.isEmpty
        ...
        : '${product?.urunAdi ?? slot.productId ?? 'Bilinmeyen Ürün'}${isBranded ? ' (${brandName ?? 'Markalı'})' : ''}';
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (slot.isEmpty)
                      Text(
                        'Slot boş. Ürün seçerek üretimi başlatabilirsin.',
