...
class FarmTypeSelectionScreen extends ConsumerStatefulWidget {
  final CityModel selectedCity;

  const FarmTypeSelectionScreen({super.key, required this.selectedCity});

  @override
  ConsumerState<FarmTypeSelectionScreen> createState() =>
      _FarmTypeSelectionScreenState();
}

class _FarmTypeSelectionScreenState
    extends ConsumerState<FarmTypeSelectionScreen> {
  ...
  Future<void> _handleEstablish() async {
    ...
    try {
      final result = await ref.read(farmActionProvider).createFarm(
