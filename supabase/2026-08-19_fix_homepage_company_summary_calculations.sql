-- Fix Homepage Company Summary Calculations
-- 1. Live Company Value calculation via calculate_player_company_value
-- 2. Accurate today_profit calculation by deducting today_production_cost
-- 3. Include real 7-day company_value_history for the sparkline trend
...
begin
  ...
  from (
    ...
    union all
    select v_company_value_num as company_val, (timezone('utc', now()))::date as history_date
