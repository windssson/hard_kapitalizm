-- ============================================================================
-- 2026-09-02: Konsolide Transfer Hedef Kalite ve Depo Türü Uyumluluğu
-- ============================================================================

-- 1. Hedef Tesisleri Listele (Kapasite, Depo Türü ve Kalite Bilgisiyle)
...
-- 2. start_city_consolidated_transfer: Kalite ve Özel Depo Doğrulamasıyla
...
BEGIN
  ...
  FOR v_item IN SELECT value FROM jsonb_array_elements(p_items) LOOP
    ...
    -- Hedef bir fabrika ise o ürünün ve kalitenin fabrika input inventory ID'sini bul
    IF p_target_entity_kind = 'factory' THEN
      ...
      IF v_item_target_pi_id IS NULL THEN
        RAISE EXCEPTION 'Hedef fabrikada bu urun (%) ve kalite (Q%) icin uygun girdi alani bulunamadi.', v_item_product_id, v_item_quality;
      END IF;
    ELSE
