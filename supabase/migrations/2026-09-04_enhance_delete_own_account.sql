-- ============================================================================
-- MIGRATION: 2026-09-04_enhance_delete_own_account.sql
-- Amaç: Hesap silme (delete_own_account) fonksiyonunu güçlendirmek:
--   1) Liderlik tablosundan (player_leaderboard_stats) tamamen silinmesi
--   2) Alıcı olduğu yoldaki transferlerin güvenle iptal edilip araçların serbest bırakılması
--   3) Başkasına kiralanmış seyir halindeki araçların ekonomiyi bozmaması için NPC'ye devri
--   4) Kişisel mesajların, bildirimlerin ve görev/başarım verilerinin GDPR/KVKK uyumlu temizliği
--   5) Boşta kalan üretim stoklarının ve pazar ilanlarının sıfırlanması
-- ============================================================================
...
BEGIN
  ...
  -- 4. Özel mesajları temizle (Gizlilik / KVKK)
  ...
  UPDATE public.factories SET is_active = false, is_producing = false, updated_at = v_now WHERE player_id = v_user_id;
