-- Redefine get_logistics_transfer_items and apply explicit execution permissions for PostgREST schema cache.
...
REVOKE ALL ON FUNCTION public.get_logistics_transfer_items(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.get_logistics_transfer_items(uuid) TO authenticated, service_role;
